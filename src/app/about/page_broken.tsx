        ...
        <div className="max-w-5xl mx-auto">
          <ScrollAnimation animation="fade-in" delay={0}>
            <div className="text-center mb-16">
              <div className="relative inline-block">
                ...
                <h1 className="relative text-6xl font-bold text-white mb-6 glow-text slide-in-top stagger-1 bg-gradient-to-r from-blue-400 via-purple-400 to-pink-400 bg-clip-text text-transparent">
                  About Adam
                </h1>
              </div>
              ...
              <p className="text-xl text-gray-300 slide-in-bottom stagger-2 max-w-3xl mx-auto leading-relaxed">
                Meet the passionate educator and creator behind Adam's Alphabet, dedicated to making mathematics accessible to all students
              </p>
              <div className="mt-6 flex justify-center gap-3">
                <Badge variant="blue">🎓 Senior Student</Badge>
                <Badge variant="purple">📚 Math Tutor</Badge>
                <Badge variant="green">💡 Innovator</Badge>
              </div>
            </div>
          </ScrollAnimation>
          ...
          <ScrollAnimation animation="slide-up" delay={200}>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
              <div className="bg-gradient-to-br from-blue-500/10 to-cyan-500/10 backdrop-blur-sm rounded-2xl p-6 glow-border card-hover group relative overflow-hidden">
              ...
              <div className="bg-gradient-to-br from-purple-500/10 to-pink-500/10 backdrop-blur-sm rounded-2xl p-6 glow-border card-hover group relative overflow-hidden">
          ...
          <ScrollAnimation animation="scale-in" delay={400}>
            <section className="bg-gradient-to-br from-blue-500/10 to-purple-500/10 backdrop-blur-sm rounded-2xl p-10 glow-border card-hover mb-16 relative overflow-hidden">
              ...
              <div className="relative z-10">
                <div className="flex flex-col md:flex-row items-center gap-8">
                  <div className="flex-shrink-0">
                    <div className="relative w-48 h-48 rounded-full overflow-hidden glow-border group">
                      <Image
                        src="/adampic.jpg"
                  ...
                  <div className="flex-1 text-center md:text-left">
                    <h2 className="text-4xl font-semibold text-white mb-4 glow-text bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent">
                      Founder: Adam Issac
                    </h2>
                    ...
                    <div className="flex flex-wrap gap-2">
                      <Badge variant="blue">🎓 High School Senior</Badge>
                      <Badge variant="purple">📚 Math Tutor</Badge>
                      <Badge variant="green">💡 Educational Innovator</Badge>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="space-y-16">
            ...
            <ScrollAnimation animation="slide-up" delay={600}>
              <section className="bg-gradient-to-br from-gray-800/40 to-gray-900/40 backdrop-blur-sm rounded-2xl p-10 glow-border card-hover relative overflow-hidden">
                <div className="absolute top-0 left-0 w-32 h-32 bg-gradient-to-br from-gray-500/20 to-gray-600/20 rounded-full blur-2xl"></div>
                <div className="relative z-10">
                  <h2 className="text-4xl font-semibold text-white mb-8 glow-text bg-gradient-to-r from-gray-300 to-white bg-clip-text text-transparent">
                    My Story
                  </h2>
            ...
            <ScrollAnimation animation="slide-up" delay={800}>
              <section className="bg-gradient-to-br from-blue-500/10 to-purple-500/10 backdrop-blur-sm rounded-2xl p-10 glow-border card-hover relative overflow-hidden">
                <div className="absolute top-0 right-0 w-40 h-40 bg-gradient-to-br from-blue-500/20 to-purple-500/20 rounded-full blur-3xl"></div>
                <div className="relative z-10">
                  <h2 className="text-4xl font-semibold text-white mb-8 glow-text bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent">
                    My Mission
                  </h2>
              <div className="prose prose-lg text-gray-300 leading-relaxed">
                <p className="mb-6 text-lg">
            ...
            <ScrollAnimation animation="slide-up" delay={1000}>
              <section className="bg-gradient-to-br from-green-500/10 to-teal-500/10 backdrop-blur-sm rounded-2xl p-10 glow-border card-hover relative overflow-hidden">
                <div className="absolute top-0 left-0 w-32 h-32 bg-gradient-to-br from-green-500/20 to-teal-500/20 rounded-full blur-2xl"></div>
                <div className="relative z-10">
                  <h2 className="text-4xl font-semibold text-white mb-8 glow-text bg-gradient-to-r from-green-400 to-teal-400 bg-clip-text text-transparent">
            ...
            <ScrollAnimation animation="slide-up" delay={1200}>
              <section className="bg-gradient-to-br from-green-500/10 to-blue-500/10 backdrop-blur-sm rounded-2xl p-10 glow-border card-hover relative overflow-hidden">
                ...
                <div className="relative z-10">
                  <h2 className="text-4xl font-semibold text-white mb-8 glow-text bg-gradient-to-r from-green-400 to-blue-400 bg-clip-text text-transparent">
                    Get in Touch
                  </h2>
